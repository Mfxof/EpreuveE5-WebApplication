          ...
          var e = (function (t) {
              ...
              return (
                (n = n.filter(function (e) {
                  return !(
                    e.outerHTML.indexOf("></") > -1 &&
                    ((t = t.replace(e.outerHTML, "")), 1)
                  );
                })).forEach(function (e) {
                  t = t.replace(
                    new RegExp(
            ...
            (o = (function (t) {
              for (var e = !0; e; )
                t.some(function (e, n) {
                  return !(
                    "object" !== f(e) ||
                    (!e.isLastCharacter && null !== e.content) ||
                    "%}" !== t.slice(n + 1, n + 3).join("") ||
                    (t.splice(n + 1, 2), 0)
                  );
                }) || (e = !1);
              return t;
        ...
        return (
          ...
          (n = [
            ...
            },
            {
              ...
              value: function () {
                return (
                  (this.waiting = g(this.executed).concat(g(this.waiting))),
                  (this.executed = []),
                  this
                );
              },
        ...
        q = (function () {
          function t() {
            ...
            !(function (t, e) {
              ...
              (this.isInput = u(n)),
              (this.opts = a({}, i, o)),
              (this.opts.strings = l(this.opts.strings)),
              (this.opts.html = !this.isInput && this.opts.html),
              (this.queue = new b(c, [this.pause, this.opts.startDelay])),
              y(n, this.isInput),
              this.prepareDelay("nextStringDelay"),
              this.prepareDelay("loopDelay");
            var f = this.$e.innerHTML;
            this.prepDOM(),
              this.handleHardCoded(f),
              (this.opts.strings = this.opts.strings.map(function (t) {
                return t.replace(/<\!--.*?-->/g, "");
              })),
            ...
            (n = [
              ...
              },
              {
                ...
                value: function () {
                      ...
                      i = function (i) {
                        ...
                        n = n.then(function () {
                          return new Promise(function (e, n) {
                            ...
                            var i, s;
                            (t.setPace(),
                            r[2] && r[2].isFirst && t.opts.beforeString) &&
                              (i = t.opts).beforeString.apply(i, o);
                            t.opts.beforeStep &&
                              (s = t.opts).beforeStep.apply(s, o);
                            r[0].call(t, r[1], r[2]).then(function () {
                              var n,
                                i,
                                s = t.queue.waiting.shift();
                              if (r[2] && r[2].isPhantom) return e();
                              r[2] &&
                                r[2].isLast &&
                                t.opts.afterString &&
                                (n = t.opts).afterString.apply(n, o);
                              t.opts.afterStep &&
                                (i = t.opts).afterStep.apply(i, o);
                  ...
                  n.then(function () {
                    if (t.opts.loop) {
                      var e = t.opts.loopDelay
                        ? t.opts.loopDelay
                        : t.opts.nextStringDelay;
                      t.wait(function () {
                        t.loopify(e), t.fire();
                      }, e.after);
                    }
                    (t.status.completed = !0),
                      t.opts.afterComplete && t.opts.afterComplete(t);
                  }).catch(function () {});
                },
              },
              {
                ...
                value: function (t) {
                  ...
                  this.queue.reset().delete(0).add([this.pause, t.before], !0),
                    this.getNoderized().forEach(function (t) {
                ...
                value: function (t) {
                  ...
                  this.isInput
                    ...
                    : ((e
                      ...
                      this.setContents(this.getRaw().split("").join("")));
                },
              },
              {
                key: "handleHardCoded",
                value: function (t) {
                  return (
                    ...
                    (this.opts.startDelete
                      ...
                      : void (this.opts.strings = w(l(t.trim())).concat(
                          w(this.opts.strings)
                        )))
                  );
                },
      ...
      var x = (function () {
        function t(e, n) {
          !(function (t, e) {
            ...
            (this.instances = C(e).map(function (t) {
              return new q({
                element: t,
