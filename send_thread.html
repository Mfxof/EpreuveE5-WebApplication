                    ...
                    <div class="ask-question-input-part032">
                        ...
                        <form>
                            <div class="username-part940">
                                <span class="form-description43">Pseudo* <br> </span><input type="text" name="fname"
                            ...
                            <div class="question-title39">
                                <span class="form-description433">Titre de la question* </span><input type="text" name="fname"
                                    class="question-ttile32" placeholder="Mettre le titre de la question ici">
                            </div>
